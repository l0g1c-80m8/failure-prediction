...
class RobotiqGripper( mm.Instrument ):
    ...
    def reset(self):
        ...
        # self.write_registers(1000,[0b0000000000000000,0,0])
...
#Test
if True:
    grip=RobotiqGripper(portname='/dev/serial/by-id/usb-ROBOTIQ_INC._I_O_Coupling_333535383038510400460032-if00')
    # print(grip.isActivated())
    # grip.activate()
    # print(grip.isActivated())
