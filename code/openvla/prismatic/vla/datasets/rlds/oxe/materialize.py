...
def make_oxe_dataset_kwargs(
    ...
    if dataset_kwargs["action_encoding"] not in [ActionEncoding.EEF_POS, ActionEncoding.EEF_R6, ActionEncoding.F_RISK]:
        raise ValueError(f"Cannot load `{dataset_name}`; only EEF_POS, EEF_R6 & F_RISK actions supported!")
    ...
    elif dataset_kwargs["action_encoding"] is ActionEncoding.F_RISK:
        dataset_kwargs["absolute_action_mask"] = [True]
        dataset_kwargs["action_normalization_mask"] = [False]
